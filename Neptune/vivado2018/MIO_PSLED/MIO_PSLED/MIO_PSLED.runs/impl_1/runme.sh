...
HD_PWD='G:/Git/fpgaLearning/Neptune/vivado2018/MIO_PSLED/MIO_PSLED/MIO_PSLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mio_psled_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mio_psled_design_wrapper.tcl -notrace
