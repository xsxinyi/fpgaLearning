...
HD_PWD='G:/Git/fpgaLearning/Neptune/vivado2018/MIO_PSLED/MIO_PSLED/MIO_PSLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mio_psled_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mio_psled_design_wrapper.tcl
