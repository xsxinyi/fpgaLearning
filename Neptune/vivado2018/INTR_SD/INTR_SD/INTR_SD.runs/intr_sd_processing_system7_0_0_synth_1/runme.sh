...
HD_PWD='G:/Git/fpgaLearning/Neptune/vivado2018/INTR_SD/INTR_SD/INTR_SD.runs/intr_sd_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log intr_sd_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source intr_sd_processing_system7_0_0.tcl
