...
HD_PWD='G:/Git/fpgaLearning/Neptune/vivado2018/INTR_SD/INTR_SD/INTR_SD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log intr_sd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source intr_sd_wrapper.tcl -notrace
