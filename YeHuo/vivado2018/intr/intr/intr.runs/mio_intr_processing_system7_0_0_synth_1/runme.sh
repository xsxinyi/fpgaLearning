...
HD_PWD='G:/Git/fpgaLearning/YeHuo/vivado2018/intr/intr/intr.runs/mio_intr_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mio_intr_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mio_intr_processing_system7_0_0.tcl
