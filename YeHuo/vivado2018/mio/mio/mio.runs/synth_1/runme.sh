...
HD_PWD='G:/Git/fpgaLearning/YeHuo/vivado2018/mio/mio/mio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mio_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mio_design_wrapper.tcl
