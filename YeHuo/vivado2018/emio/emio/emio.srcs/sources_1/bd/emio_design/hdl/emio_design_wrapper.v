...
//Command     : generate_target emio_design_wrapper.bd
//Design      : emio_design_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module emio_design_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  emio_design emio_design_i
       (.DDR_addr(DDR_addr),
        ...
        .GPIO_EMIO_tri_i({GPIO_EMIO_tri_i_1,GPIO_EMIO_tri_i_0}),
        .GPIO_EMIO_tri_o({GPIO_EMIO_tri_o_1,GPIO_EMIO_tri_o_0}),
        .GPIO_EMIO_tri_t({GPIO_EMIO_tri_t_1,GPIO_EMIO_tri_t_0}));
endmodule
