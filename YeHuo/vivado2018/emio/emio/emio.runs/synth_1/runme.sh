...
HD_PWD='G:/Git/fpgaLearning/YeHuo/vivado2018/emio/emio/emio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log emio_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source emio_design_wrapper.tcl
