...
HD_PWD='G:/Git/fpgaLearning/YeHuo/vivado2018/emio/emio/emio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log emio_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source emio_design_wrapper.tcl -notrace
