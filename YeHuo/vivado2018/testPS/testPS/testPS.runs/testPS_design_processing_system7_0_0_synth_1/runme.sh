...
HD_PWD='G:/Git/fpgaLearning/YeHuo/vivado2018/testPS/testPS/testPS.runs/testPS_design_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testPS_design_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testPS_design_processing_system7_0_0.tcl
