...
HD_PWD='G:/Git/fpgaLearning/YeHuo/vivado2018/led_zynq/led_ip_pl/led_ip_pl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_ip_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_ip_design_wrapper.tcl
