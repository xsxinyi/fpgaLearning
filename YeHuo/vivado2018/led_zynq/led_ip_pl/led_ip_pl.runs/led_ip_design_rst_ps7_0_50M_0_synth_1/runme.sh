...
HD_PWD='G:/Git/fpgaLearning/YeHuo/vivado2018/led_zynq/led_ip_pl/led_ip_pl.runs/led_ip_design_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_ip_design_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_ip_design_rst_ps7_0_50M_0.tcl
