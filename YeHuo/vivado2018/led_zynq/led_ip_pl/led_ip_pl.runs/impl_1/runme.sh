...
HD_PWD='G:/Git/fpgaLearning/YeHuo/vivado2018/led_zynq/led_ip_pl/led_ip_pl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_ip_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_ip_design_wrapper.tcl -notrace
